...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_tophitsproducts?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_topratingproducts?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_bestsellerproducts?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_randomproducts?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_lastproducts?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
...
<tr>
    <td><b><?php print _JSHP_SEOPAGE_search?></b></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_PAGE?>
    </td>
    <td><input type="text" name="count_products_to_page_search" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_search;?>" /></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_ROW?>
    </td>
    <td><input type="text" name="count_products_to_row_search" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_search;?>" /></td>
</tr>
