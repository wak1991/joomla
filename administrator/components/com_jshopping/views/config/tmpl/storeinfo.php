...
<fieldset class="adminform">
    ...
    <td >
        ...
        <a class="btn" target="_blank" href="index.php?option=com_jshopping&controller=config&task=preview_pdf&config_id=<?php echo $jshopConfig->id?>"><?php echo _JSHOP_PDF_PREVIEW?></a>
    </td>
    </tr>
    </table>
