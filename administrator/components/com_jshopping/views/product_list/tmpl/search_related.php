...
<tr>    
    ...
    <div class="pagination related">
        ...
        <div class="page">
            ...
            ?>
            <?php if ($pstart>1){?>
                <a onclick="releted_product_search(0, <?php print $this->no_id?>, 1);return false;" href="#">
                    <span class="icon-first"></span>
                </a>
                <span>...</span>
            <?php }?>
            <?php for($i=$pstart;$i<=$pfinish; $i++){?>
                <a class="p<?php print $i?> <?php if ($i==1){?>active<?php }?>" onclick="releted_product_search(<?php print ($i-1)*$this->limit;?>, <?php print $this->no_id?>, <?php print $i?>);return false;" href="#">
                    <?php print $i;?>
                </a>
            <?php } ?>
            <?php if ($pfinish<$this->pages){?>
                <span>...</span>
                <a onclick="releted_product_search(<?php print ($this->pages-1)*$this->limit;?>, <?php print $this->no_id?>, <?php print $this->pages?>);return false;" href="#">
