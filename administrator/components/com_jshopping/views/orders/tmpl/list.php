		...
		<?php if ($jshopConfig->generate_pdf){?>
            <?php if ($display_info_order && $row->order_created){?>
                ...
                <?php }elseif($jshopConfig->send_invoice_manually){?>
                    <a href="index.php?option=com_jshopping&controller=orders&task=send&order_id=<?php echo $row->order_id?>&back=orders" title="<?php print _JSHOP_SEND_MAIL?>">
