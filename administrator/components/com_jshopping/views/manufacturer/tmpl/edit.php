   ...
   foreach($this->languages as $lang){
     ...
     <table class="admintable">
       <tr>
         ...
         <td>
           <input type="text" class="inputbox wide" name="<?php print $name?>" value="<?php print $row->$name?>" />
         </td>
       </tr>
       <tr>
         <td class="key">
     ...
     <div class="jshop_quote" id="image_manufacturer">
        <div>
            ...
            <div class="link_delete_foto">
                <a class="btn btn-micro" href="#" onclick="if (confirm('<?php print _JSHOP_DELETE_IMAGE;?>')) deleteFotoManufacturer('<?php echo $row->manufacturer_id?>');return false;">
