...
define('_JSHOP_CONFIRM_REMOVE_ALL', 'Wirklich alles entfernen?');
...
define('_JSHOP_REGWARN_PRIVACY_STATEMENT', 'Bitte bestätigen Sie die Datenschutzerklärung');
...
define('_JSHOP_CLIENT_ID', 'Kunden ID');
...
define('_JSHOP_WISHLIST_EMPTY','Ihre Wunschliste ist derzeit leer.');
...
define('_JSHOP_ERROR_SHIPPING','Fehler Lieferart konfiguration');
...
define('_JSHOP_ERROR_QUANTITY','Error quantity');
define('_JSHOP_CLEAR_CART','Warenkorb löschen');
