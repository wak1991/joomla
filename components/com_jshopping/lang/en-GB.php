...
define('_JSHOP_CONFIRM_REMOVE_ALL', 'Really remove all?');
...
define('_JSHOP_REGWARN_PRIVACY_STATEMENT', 'Please confirm Privacy Statement');
...
define('_JSHOP_CLIENT_ID', 'Client ID');
...
define('_JSHOP_WISHLIST_EMPTY','Your Wishlist is currently empty.');
...
define('_JSHOP_ERROR_SHIPPING','Error shipping configuration');
...
define('_JSHOP_CLEAR_CART','Clear Cart');
